...
const LoginFrm = () => {
  ...
  const { setSelectedPage,configdata} = useContext(RenderContext)
        ...
        <div className="wrapper fadeInDown">
          <div id="formContent">
            ...
            <form>
              ...
              <input type="button" onClick={()=>{ setSelectedPage('user-profile')}} className="fadeIn fourth" value="Log In" />
            </form>

            <div id="formFooter">
              <a className="underlineHover" href="/" >itsm.dev</a>
            </div>
