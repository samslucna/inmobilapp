...
export default function Form() {
  const { state, errors, handleChange, handleSubmit, handleBlur } =
    useValidatorForm(ClientStore.client, clientValidate, ClientStore.addClient);
      ...
      <Box display="flex" alignItems="center">
        <Card sx={{ p: 4 }}>
          <Typography variant="h6" sx={{ mb: 2 }}>
             {id ===null? 'Nuevo clieete' : 'Editar cliente'}
          </Typography>
          ...
          <DialogActions sx={{ p: 3 }}>
            <Button
              onClick={() => {
                ClientStore.setHiddenForm(false);
                ClientStore.setEditing(false);
              }}
